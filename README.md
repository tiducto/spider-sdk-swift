...
- **`client.routing`** — trip planning (with paging and a streaming `planStream` / `planStreamNext` / `planStreamPrevious`), departures, and single-trip lookups.
